# Carts app
angular.module('cartsApp', ['carts_controller', 'carts_service', 'cart_shirts_service', 'application_services', 'alert_directives', 'application_directives', 'application_filters'])
